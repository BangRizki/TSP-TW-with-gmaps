...
var destinationsDefault = [
  ["Jatim Park 1", -7.882761426277335, 112.52496600044456],
  ["Museum Angkut", -7.878122515352549, 112.51992344803236],
  ["Jatim Park 2", -7.887827220606441, 112.52936592031656],
];
...
function initializeMap() {
  map = new google.maps.Map(document.getElementById("map-canvas"), {
    center: { lat: -6.807990876191125, lng: 110.84075505852005 },
    zoom: 16,
    mapTypeId: "terrain",
        ...
        */
        ...
        directionsService.route(request, function (response, status) {
          if (status == google.maps.DirectionsStatus.OK) {
            ...
            document.getElementById("rangkuman_rute").innerHTML = rangkuman_rute;
...
var ga = {
  ...
  */
  getConfig: function () {
    // $("#rasio-crossover").on("change", function(){
    //   ga.crossoverRate = parseFloat($("#rasio-crossover").val());
    //   $("#crossover-terpilih").text(ga.crossoverRate);
    // });
    // $("#rasio-mutasi").on("change", function(){
    //   ga.mutationRate = parseFloat($("#rasio-mutasi").val());
    //   $("#mutasi-terpilih").text(ga.mutationRate);
    // });
    // $("#jumlah-populasi").on("change", function(){
    //   ga.populationSize = parseInt($("#jumlah-populasi").val());
    //   $("#populasi-terpilih").text(ga.populationSize);
    // });
    // $("#elitism").on("change", function(){
    //   ga.elitism = parseInt($("#elitism").val());
    //   $("#elitism-terpilih").text(ga.elitism);
    // });
    // $("#maxGenerations").on("change", function(){
    //   ga.maxGenerations = parseInt($("#maxGenerations").val());
    //   $("#generasi-terpilih").text(ga.maxGenerations);
    // });
    ga.crossoverRate = parseFloat($("#rasio-crossover").val());
    $("#crossover-dipilih").text(ga.crossoverRate);
    ga.mutationRate = parseFloat($("#rasio-mutasi").val());
    $("#mutasi-dipilih").text(ga.mutationRate);
    ga.populationSize = parseInt($("#jumlah-populasi").val());
    $("#populasi-dipilih").text(ga.populationSize);
    ga.elitism = parseInt($("#elitism").val());
    $("#elitism-dipilih").text(ga.elitism);  
    ga.maxGenerations = parseInt($("#maxGenerations").val());
